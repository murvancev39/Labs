 ...
 * @brief Реализация функций генерации тестовых наборов данных.
 *
 * В функциях жестко прописан вызов `srand(42)`. Это сделано намеренно,
 * чтобы при каждом запуске программы хеш-таблицы тестировались на абсолютно
 * одинаковых входных последовательностях, позволяя объективно сравнивать коллизии.
 */
